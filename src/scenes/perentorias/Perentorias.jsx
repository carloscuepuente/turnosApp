...
import PerentoriasModal from "./PerentoriasModal";
...
const Perentorias = (props) => {
    ...
    const [currentEvents, setCurrentEvents] = useLocalStorageState("perentorias", [])
                    ...
                    <Box display="flex" justifyContent="space-between">
                        ...
                        <Box flex="1 1 100%" ml={{ xs: 0, md: "15px" }}>
                            <FullCalendar
                                ...
                                //cuanto tiene que presionar en moviles para que se active el dia
                        ...
                        {open ? <PerentoriasModal dateInfoClick={dateInfoClick} open={open} setOpen={setOpen} onEventAdded={event => onEventAdded(event)} /> : ""}
                    </Box>
                </Grid>
